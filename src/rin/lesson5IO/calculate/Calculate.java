...
public class Calculate {
	 ...
	 * @throws Exception
	 */
	public static double calcutePostfixExpression(final List<Token> tokenList) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static double doCalcute(final Token operator, final Stack<Double> numStack) throws Exception {
		double result = 0d;
